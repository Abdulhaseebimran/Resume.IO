...
import { FileText, Loader2, Mail, Lock, User, Chrome, Eye, EyeOff } from "lucide-react";
        ...
        <div className="min-h-screen bg-primary-bg flex items-center justify-center p-4">
            <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500">
                ...
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-xl font-semibold text-text-primary">Create Your Account</h2>
                ...
                <div className="bg-card-bg p-6 sm:p-8 rounded-2xl border border-border-custom shadow-xl">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full btn-gradient py-3 mt-2 flex items-center justify-center gap-2 group"
                        >
                    ...
                    <div className="mt-8 relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-card-bg px-2 text-text-secondary font-medium">Or join with</span>
                        </div>
                    </div>
